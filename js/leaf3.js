...
function refresh() {
  ...
  for (let k = 0; k < currentGame.goodies.length; k++) {
    ...
    function xCollision() {
      if (
        vertexWidth <
        0.5 * currentLeaf.width + 0.5 * currentGame.goodies[k].width
      ) {
        return true;
      }
      return false;
    ...
    function yCollision() {
      if (
        vertexHeight <
        0.5 * currentLeaf.height + 0.5 * currentGame.goodies[k].height
      ) {
        return true;
      }
      return false;
  ...
  for (let k = 0; k < currentGame.cops.length; k++) {
    ...
    function xCollision() {
      if (
        vertexWidth <
        0.5 * currentLeaf.width + 0.5 * currentGame.cops[k].width
      ) {
        return true;
      }
      return false;
    ...
    function yCollision() {
      if (
        vertexHeight <
        0.5 * currentLeaf.height + 0.5 * currentGame.cops[k].height
      ) {
        return true;
      }
      return false;
  ...
  for (let i = 0; i < currentGame.skyscrapers.length; i++) {
    ...
    function xCollision() {
      if (
        vertexWidth <
        0.5 * currentLeaf.width + 0.5 * currentGame.skyscrapers[i].width
      ) {
        return true;
      }
      return false;
    ...
    function yCollision() {
      if (
        vertexHeight <
        0.5 * currentLeaf.height + 0.5 * currentGame.skyscrapers[i].height
      ) {
        return true;
      }
      return false;
  ...
  for (let k = 0; k < currentGame.birds.length; k++) {
    ...
    function xCollision() {
      if (
        vertexWidth <
        0.5 * currentLeaf.width + 0.5 * currentGame.birds[k].width
      ) {
        return true;
      }
      return false;
    ...
    function yCollision() {
      if (
        vertexHeight <
        0.5 * currentLeaf.height + 0.5 * currentGame.birds[k].height
      ) {
        return true;
      }
      return false;
